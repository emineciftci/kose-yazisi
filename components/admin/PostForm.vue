        ...
        <fieldset>
          ...
          <legend v-else>Yeni Köse Yazısı</legend>
            <div class="form-group">
                ...
                <input v-model="post.title" type="text" class="form-control" placeholder="Yazarın adını giriniz..">
            </div>
            <div class="form-group">
                <label>Baslık</label>
                <input v-model="post.subTitle" type="text" class="form-control" placeholder="Yazının baslıgını giriniz..">
            </div>
            <div class="form-group">
                <label>Alt Baslık</label>
                <input v-model="post.author" type="text" class="form-control" placeholder="Yazının alt baslıgını giriniz..">
            </div>
            <div class="form-group">
